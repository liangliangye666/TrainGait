...
const std::unordered_map<AllJoints, std::string> jointToString = {
    {AllJoints::left_hip_roll_joint, "left_hip_roll_joint"},
    {AllJoints::left_hip_pitch_joint, "left_hip_pitch_joint"},
    {AllJoints::left_knee_joint, "left_knee_joint"},
    {AllJoints::left_wheel_joint, "left_wheel_joint"},
    {AllJoints::right_hip_roll_joint, "right_hip_roll_joint"},
    {AllJoints::right_hip_pitch_joint, "right_hip_pitch_joint"},
    {AllJoints::right_knee_joint, "right_knee_joint"},
    {AllJoints::right_wheel_joint, "right_wheel_joint"},
};
...
class RobotModel {
 public:
  ...
  double vel_des_;
  double omega_des_;
  double delta_height_des_;
  double height_des_;
  double step_rise_height_des_;
  double jump;
  int jump_time_window;
