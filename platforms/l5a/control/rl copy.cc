...
void RL::Run(RobotModel& robot_model) {
  ...
  pos_ref.segment(2, 1).setZero();  // wheel pos ref set to zero
  pos_ref.segment(5, 1).setZero();

  vel_ref.segment(0, 2).setZero();  // joint vel ref set to zero
  vel_ref.segment(3, 2).setZero();
