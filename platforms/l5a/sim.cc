...
void MyController(const mjModel* m, mjData* d) {
  ...
  static int time = 0;
  // if (time <= 400) time++;
  // else if (time <= 500+robot_model.jump_time_window){
  //   robot_model.jump = 1.0;
  //   time++;
  // }else if (time <= 800+robot_model.jump_time_window){
  //   robot_model.jump = 0;
  //   time++;
  // // }else if (time <= 1200+robot_model.jump_time_window){
  // //   robot_model.jump = 1.0;
  // //   time++;
  // // }else if (time <= 1200){
  // //   robot_model.jump = 0;
  ...
  // //   time++;
  // // }else if (time <= 1700+robot_model.jump_time_window){
  // //   robot_model.jump = 1.0;
  // //   time++;
  // // }else if (time <= 1800){
  // //   robot_model.jump = 0.0;
